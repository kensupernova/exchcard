    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fromaddress', models.ForeignKey(related_name='from_addresses', default=None, to='exchcard.Address')),
            ],
            options={
                'ordering': ('created',),
            },
        ...
        migrations.AddField(
            model_name='card',
            name='toaddress',
            field=models.ForeignKey(related_name='to_addresses', default=None, to='exchcard.Address'),
        ),
        migrations.AddField(
            model_name='card',
            name='torecipient',
            field=models.ForeignKey(related_name='received_cards', default=1, to='exchcard.Profile'),
        ),
    ]
