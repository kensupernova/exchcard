...
def _http_call(the_url, method, authorization, **kw):
    ...
    http_url = '%s?%s' % (the_url, params) if method == _HTTP_GET else the_url ## 如果是GET, 在url里面加parameter
    http_body = None if method == _HTTP_GET else params ## 如果是POST, parameter是request body
...
class APIClient(object):
    ...
    def refresh_token(self, refresh_token):
        """
        用旧的access_token换取新的access_token
        :param refresh_token:
        :return:
        """
