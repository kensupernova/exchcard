...
LEXERS = {
    ...
    'RstLexer': ('pygments.lexers.markup', 'reStructuredText', ('rst', 'rest_demo', 'restructuredtext'), ('*.rst', '*.rest_demo'), ('text/x-rst', 'text/prs.fallenstein.rst')),
    ...
    'SLexer': ('pygments.lexers.r', 'S', ('splus', 's', 'r'), ('*.S', '*.R', '.Rhistory', '.Rprofile', '.Renviron'), ('text/S-plus', 'text/S', 'text/x-r-source', 'text/x-r', 'text/x-R', 'text/x-r-history', 'text/x-r-exchcard_backend_api')),
