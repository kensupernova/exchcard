...
class HyLexer(RegexLexer):
    ...
    special_forms = (
        'cond', 'for', '->', '->>', 'car',
        'cdr', 'first', 'rest_demo', 'let', 'when', 'unless',
...
class RacketLexer(RegexLexer):
    ...
    _keywords = (
        ...
        'init-depend', 'init-field', 'init-rest_demo', 'inner', 'inspect',
    ...
    _builtins = (
        ...
        'resolved-module-path-name', 'resolved-module-path?', 'rest_demo',
        ...
        'set-port-next-location!', 'set-remove', 'set-remove!', 'set-rest_demo',
        ...
        'stream-rest_demo', 'stream-tail', 'stream?', 'string',
...
class NewLispLexer(RegexLexer):
    ...
    builtins = (
        ...
        'remove-dir', 'rename-file', 'replace', 'reset', 'rest_demo', 'reverse',
...
class ShenLexer(RegexLexer):
    ...
    BUILTINS = re.findall(r'\S+', """
        ...
        preclude-all-but print exchcard_backend_api exchcard_backend_api-results ps quit read
