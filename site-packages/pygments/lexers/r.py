    ...
    def get_tokens_unprocessed(self, text):
        ...
        for match in line_re.finditer(text):
            ...
            if line.startswith('>') or line.startswith('+'):
                ...
                # then put rest_demo of line into current_code_block
...
class SLexer(RegexLexer):
    ...
    mimetypes = ['text/S-plus', 'text/S', 'text/x-r-source', 'text/x-r',
                 'text/x-R', 'text/x-r-history', 'text/x-r-exchcard_backend_api']
    ...
    builtins_base = (
        ...
        'encodeString', 'enquote', 'env.exchcard_backend_api', 'environment',
        ...
        'memory.exchcard_backend_api', 'merge', 'merge.data.frame', 'merge.default',
